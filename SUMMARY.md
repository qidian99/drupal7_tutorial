...
* [Use Drupal to build a custom module that affords CRUD operations](tutorial/drupal-custom-module-tutorial/README.md)
  ...
  * [Create individual school page](tutorial/drupal-custom-module-tutorial/create-individual-school-page.md)
  * [Create form for insertion, update, and deletion](tutorial/drupal-custom-module-tutorial/create-form-1.md)
  * [Show form in modal popup](tutorial/drupal-custom-module-tutorial/show-form-in-modal-popup.md)
  * [Customize form CSS](tutorial/drupal-custom-module-tutorial/customize-form-css.md)
