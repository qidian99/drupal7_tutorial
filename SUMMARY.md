...
* [Use Drupal to build a custom module that affords CRUD operations](tutorial/use-drupal-to-build-a-crud-api/README.md)
  * [Create the Schools module](tutorial/use-drupal-to-build-a-crud-api/create-the-schools-module.md)
  * [Create individual school page](tutorial/use-drupal-to-build-a-crud-api/create-individual-school-page.md)
